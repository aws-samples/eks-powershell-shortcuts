...
curl -o $env:TMP/install-k8s-dashboard-on-EKS.ps1 https://raw.githubusercontent.com/aws-samples/eks-powershell-shortcuts/main/src/install-k8s-dashboard-on-EKS.ps1
